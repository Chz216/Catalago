        ...
        <div class="col-left filters">
          ...
          <div class="block-filters">
            <dl>
              ...
              <form action="dama.php" method="get">
                <dd class="price">
                  <p><span id="amount"></span></p>
                  <div class="price-range" id="slider-range"></div>
                  <input id="amount1" class="slider-range" name="Min" type="hidden">
                  <input id="amount2" class="slider-range" name="Max" type="hidden">
                  <input type="submit">
                </dd>
              </form>
